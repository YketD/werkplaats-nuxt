<template>
    <div class="page-container">
        <div class="contact-info-container">
            <h1 v-if="document.titel && document.titel[0]" class="big-title">
                {{document.titel[0].text}}
            </h1>
            <h1 v-else class="big-title">
                WERKPLEKKEN
            </h1>
            <div class="info-container">
                <div v-if="document.text && document.text[0]" class="info">
        ...
        <div class="content">
            <div v-if="false" id="bubbles">
                <div class="bubble bubble-1">
                    <div class="bubble-content">Vrije
                                                toegang tot wifi
                    </div>
                </div>
                <div class="bubble bubble-2">
                    <div class="bubble-content">In de
                ...
                <div class="bubble bubble-3">
                    <div class="bubble-content">Bij het
                                                gebruik van
...
<script>
    ...
    export default {
        ...
        async asyncData({ $prismic, error }) {
            try{
                const documentResponse = await $prismic.api.query($prismic.predicates.at("document.type", "werkplek_huren"));
...
<style lang="scss" scoped>
    ...
    .bubble {
        ...
        color                      : rgb(32, 64, 37);
        font-size                  : 32px;
        border                     : 5px solid rgb(232, 138, 96);
        background-color           : rgba(232, 138, 96, .2);
